...
- **84 keybinds in the coverage inventory**, each mapped to the automated test that protects it:
...
- **113 of 432 documented keybind rows map to an inventoried keybind**; the rest work today but are not yet individually tracked ([full list below](#documented-but-not-yet-inventoried))
...
<details>
<summary>319 untracked rows</summary>
