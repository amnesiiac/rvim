...
- **101 keybinds in the coverage inventory**, each mapped to the automated test that protects it:
...
- **140 of 429 documented keybind rows map to an inventoried keybind**; the rest work today but are not yet individually tracked ([full list below](#documented-but-not-yet-inventoried))
...
<details>
<summary>289 untracked rows</summary>
